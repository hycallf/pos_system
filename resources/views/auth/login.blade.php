...
<head>
    ...
    <style>
        ...
        .card {
            ...
            background-color: rgba(195, 246, 255, 0.8);
        }
    </style>
</head>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <p class="text-center mt-5 lead text-white">
                    Developed By
                    <a href="https://hycallf.github.io" class="font-weight-bold text-white">Hycallf</a>
                </p>
            </div>
        </div>
    </div>
