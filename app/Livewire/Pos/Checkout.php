...
class Checkout extends Component
{
    ...
    public function calculateTotal() {
        ...
        // GUNAKAN CARA BARU YANG LEBIH AKURAT:
        $sub_total = Cart::instance($this->cart_instance)->subtotal(2, '.', '');
        $discount = Cart::instance($this->cart_instance)->discount(2, '.', '');
        $tax = Cart::instance($this->cart_instance)->tax(2, '.', '');

        // Hitung total dari angka mentah
        $total = ($sub_total - $discount) + $tax + $this->shipping;
