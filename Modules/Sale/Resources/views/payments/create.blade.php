                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference" required
                                            value="INV/{{ $sale->reference }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="payment_method" id="payment_method" required>
                                    ...
                                    <option value="Midtrans">Digital Payment (Midtrans)</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            function toggleAmountField() {
                if ($('#payment_method').val() === 'Midtrans') {
                    // Jika pilih Midtrans, sembunyikan amount & set nilainya ke sisa tagihan
                    $('#amount-group').hide();
                    $('#amount').val("{{ $sale->due_amount / 100 }}").prop('required', false);
                } else {
                    // Jika pilih metode lain, tampilkan amount & wajibkan
                    $('#amount-group').show();
            ...
            // Jalankan fungsi setiap kali dropdown berubah
