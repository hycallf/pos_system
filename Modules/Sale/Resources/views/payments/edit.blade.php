                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date" required
                                            value="{{ $salePayment->getAttributes()['date'] }}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="amount" type="text" class="form-control" name="amount"
                                                required value="{{ old('amount') ?? $salePayment->amount }}">
                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                ...
                                                <option {{ $salePayment->payment_method == 'Midtrans' ? 'selected' : '' }}
                                                    value="Midtrans">Midtrans</option>
                                                <option
                                                    {{ $salePayment->payment_method == 'Credit Card' ? 'selected' : '' }}
                                                    value="Credit Card">Credit Card</option>
                                                <option
                                                    {{ $salePayment->payment_method == 'Bank Transfer' ? 'selected' : '' }}
